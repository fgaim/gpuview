...
def arg_parser():
    ...
    base_parser.add_argument("--port", default=9988, help="Port number of host (default: 9988)")
    base_parser.add_argument("--safe-zone", action="store_true", help="Report all details including usernames")
    base_parser.add_argument("--exclude-self", action="store_true", help="Don't report to others but self-dashboard")
    ...
    add_parser.add_argument("--name", default=None, help="An optional readable name for the GPU host")

    rem_parser = subparsers.add_parser("remove", help="Remove a GPU host")
    rem_parser.add_argument("--url", required=True, help="Url of the GPU node to remove")
